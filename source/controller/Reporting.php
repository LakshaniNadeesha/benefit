...
class Reporting extends Controller
{
    function index(){
        ...
        if(Auth::access('HR Manager')){
            ...
            $reim_row1=$user1->find_groupby('employee_ID','claim_date','claim_amount','reimbursement_reason','reimbursement_status',$new1,$current_date);
            $reim_row2=$user1->find_groupby('employee_ID','claim_date','claim_amount','reimbursement_reason','reimbursement_status',$new2,$current_date);
            $reim_row3=$user1->find_groupby('employee_ID','claim_date','claim_amount','reimbursement_reason','reimbursement_status',$new3,$current_date);
            $bene_row1=$user2->find_benefit_groupby('employee_ID','claim_date','benefit_type','claim_amount','benefit_description','benefit_status',$new1,$current_date);
            $bene_row2=$user2->find_benefit_groupby('employee_ID','claim_date','benefit_type','claim_amount','benefit_description','benefit_status',$new2,$current_date);
            $bene_row3=$user2->find_benefit_groupby('employee_ID','claim_date','benefit_type','claim_amount','benefit_description','benefit_status',$new3,$current_date);
            $leave_row1=$user3->find_timeoff_groupby('employee_ID','name','date','ot_hours','status',$new1,$current_date);
            $leave_row2=$user3->find_timeoff_groupby('employee_ID','name','date','ot_hours','status',$new2,$current_date);
            $leave_row3=$user3->find_timeoff_groupby('employee_ID','name','date','ot_hours','status',$new3,$current_date);
