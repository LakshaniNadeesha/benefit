...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 100 1440 180">
    <path fill="#0f9eb8" fill-opacity="1" d="M0,256L26.7,261.3C53.3,
...
<div class="confirm init">
    <div class="confirm__window ">
        ...
        <div class="confirm__content" id="dhr" style="display: none;">
            ...
            <h2>HR Department</h2>
            <p>An HR department is tasked with maximizing employee productivity and protecting the company from any
                issues that may arise
                within the workforce. HR responsibilities include compensation and benefits, recruitment, firing, and
                keeping
        ...
        <div class="confirm__content" id="dselse" style="display: none;">
            ...
            <p>The sales department consists of a set of business activities and processes that help a sales
                organization run
        ...
        <div class="confirm__content" id="dfinancial" style="display: none;">
            ...
            <h2>Financial Department</h2>
            <p>A finance department is the unit of a business responsible for obtaining and handling any monies on
                behalf of the organization.
                The department controls the income and expenditure in addition to ensuring effective business running
                with minimum disruptions.</p>
            <p>Besides the roles of handling the payroll, income and expenses, finance department responsibilities also
                include
